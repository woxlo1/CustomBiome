...
class SimplexNoise(seed: Long = 0L) {
    ...
    fun octaveNoise2D(x: Double, y: Double, octaves: Int = 6, persistence: Double = 0.5,
                      lacunarity: Double = 2.0, scale: Double = 1.0): Double {
        var total = 0.0; var frequency = scale; var amplitude = 1.0; var maxValue = 0.0
